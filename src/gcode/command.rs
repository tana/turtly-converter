...
def_command!(G0, "Rapid move", x: f64, y: f64, z: f64, i: f64, j: f64, k: f64, e: f64, f: f64);
def_command!(G1, "Linear move", x: f64, y: f64, z: f64, i: f64, j: f64, k: f64, e: f64, f: f64);
def_command!(G92, "Set position", x: f64, y: f64, z: f64, i: f64, j: f64, k: f64, e: f64);
